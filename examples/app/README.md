...
A sample Kubernetes Pulumi program used to demonstrate OPA policy enforcement.
...
You can also try with the AWS policy pack:

```bash
$ pulumi preview --policy-pack ../policy-aws
```
